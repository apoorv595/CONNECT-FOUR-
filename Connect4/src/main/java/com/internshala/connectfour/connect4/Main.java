...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // Makes the width same as width of Primary Stage
        menuBar.prefWidthProperty().bind(primaryStage.widthProperty());  // Binds the width property of primary Stage to menuBar
        ...
        primaryStage.setResizable(false);     // Restricts to resize
        primaryStage.show();
    ...
    private void aboutConnect4() {
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("About Connect Fout");
